...
for (i in 1:length(regions)) { 
  ...
  if (AIC_null >= AIC_lin) {
    ...
    TDplot <- plotROI + geom_point(data=PSdata, aes(x=Age,y=ROI),color='green',size=.6) + 
      geom_smooth(data=PSdata, aes(x=Age, y=ROI), method=lm, se=FALSE, color="green", size=.2)
    ...
    Mplot <- plotROI_Sex + geom_point(data=M_data, aes(x=Age,y=ROIM),color='blue',size=.6) + 
      geom_smooth(data=M_data, aes(x=Age, y=ROIM), method=lm, se=FALSE, color="blue", size=.2)
    Fplot <- Mplot + geom_point(data=F_data, aes(x=Age,y=ROIF),color='red',size=.6) + 
      geom_smooth(data=F_data, aes(x=Age, y=ROIF), method=lm, se=FALSE, color="red", size=.2) + 
...
#FDR correction
pvaldf <- read.csv("/Users/madisonlong/Dropbox/UniversityofCalgary/LebelLab/LebelLab_Projects/PSvPAE_Volume/ModelsTable_PSvPAE_AbsVolume_FDRCorrected_Group_20230611.csv")
pvaldf <- read.csv("/Users/madisonlong/Dropbox/UniversityofCalgary/LebelLab/LebelLab_Projects/PSvPAE_Volume/ModelsTable_PSvPAE_AbsVolume_FDRCorrected_AgebyGroup_20230611.csv")
pvaldf <- read.csv("/Users/madisonlong/Dropbox/UniversityofCalgary/LebelLab/LebelLab_Projects/PSvPAE_Volume/ModelsTable_PSvPAE_AbsVolume_FDRCorrected_Age2byGroup_20230611.csv")
pvaldf <- read.csv("/Users/madisonlong/Dropbox/UniversityofCalgary/LebelLab/LebelLab_Projects/PSvPAE_Volume/ModelsTable_PAESex_AbsVolume_FDRCorrected_Sex_20230611.csv")
pvaldf <- read.csv("/Users/madisonlong/Dropbox/UniversityofCalgary/LebelLab/LebelLab_Projects/PSvPAE_Volume/ModelsTable_PAESex_AbsVolume_FDRCorrected_AgebySex_20230611.csv")
pvaldf <- read.csv("/Users/madisonlong/Dropbox/UniversityofCalgary/LebelLab/LebelLab_Projects/PSvPAE_Volume/ModelsTable_PAESex_AbsVolume_FDRCorrected_Age2bySex_20230611.csv")
...
for (i in 1:length(regions)) { 
  ...
  if (AIC_null >= AIC_lin) {
    ...
    AgeCoef <- as.numeric(CoefDataLinPAE[2,1])
    GroupCoef <- as.numeric(CoefDataLinPAE[3,1])
    ICVCoef <- as.numeric(CoefDataLinPAE[4,1])
    AgebyGroupCoef <- as.numeric(CoefDataLinPAE[5,1])
    ...
    AgeCoef_Sex <- as.numeric(CoefDataLinPAESex[2,1])
    GroupCoef_Sex <- as.numeric(CoefDataLinPAESex[3,1])
    ICVCoef_Sex <- as.numeric(CoefDataLinPAESex[4,1])
    AgebyGroupCoef_Sex <- as.numeric(CoefDataLinPAESex[5,1])
  ...
  if (bestAIC >= AIC_quad) {
    ...
    GroupCoef <- as.numeric(CoefDataQuadPAE[3,1])
    AgeCoef <- as.numeric(CoefDataQuadPAE[4,1])
    ICVCoef <- as.numeric(CoefDataQuadPAE[5,1])
    Age2byGroupCoef <- as.numeric(CoefDataQuadPAE[6,1])
    AgebyGroupCoef <- as.numeric(CoefDataQuadPAE[7,1])
    ...
    GroupCoef_Sex <- as.numeric(CoefDataQuadPAESex[3,1])
    AgeCoef_Sex <- as.numeric(CoefDataQuadPAESex[4,1])
    ICVCoef_Sex <- as.numeric(CoefDataQuadPAESex[5,1])
    Age2byGroupCoef_Sex <- as.numeric(CoefDataQuadPAESex[6,1])
    AgebyGroupCoef_Sex <- as.numeric(CoefDataQuadPAESex[7,1])
